            ...
            <div className="p-6">
              ...
              <div className="mb-4">
                {project.tags.map((tag , index) => (
                  <span
                  key={index}
                  className="inline-block bg-[#251f38] text-xs font-semibold text-purple-500 mr-2 px-2 py-1 mb-2 rounded-full"
                  >
                    {tag}
                  </span>
                ))}
          ...
          <div className="bg-gray-900 rounded-xl shadow-2xl lg:w-full w-[90%] max-w-3xl overflow-hidden relative">
            ...
            <div className="flex flex-col">
              ...
              <div className="lg:p-8 p-6">
                <h3 className="lg:text-3xl font-bold text-white mb-4 text-2xl">{selectedProject.title}</h3>

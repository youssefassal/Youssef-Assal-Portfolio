          ...
          <div className="mt-4 flex flex-col space-y-4">
            <div className="w-full p-3 rounded-md bg-[#131025] text-white border border-gray-600 focus:outline-none focus:border-purple-500">
              <h2 className="text-white">
                <IoLocationSharp className="inline mr-2 mb-1 text-purple-500 text-2xl" />
                Location:
              </h2>
            ...
            <div className="w-full p-3 rounded-md bg-[#131025] text-white border border-gray-600 focus:outline-none focus:border-purple-500">
              <h2 className="text-white">
                <MdEmail className="inline mr-2 mb-1 text-purple-500 text-2xl" />
                Email:
              </h2>
            ...
            <div className="w-full p-3 rounded-md bg-[#131025] text-white border border-gray-600 focus:outline-none focus:border-purple-500">
              <h2 className="text-white">
                <FaPhone className="inline mr-2 mb-1 text-purple-500 text-2xl" />
                Phone:
              </h2>
              <h3 className="text-gray-400">+201019392354</h3>
            </div>
            <div className="w-full p-3 rounded-md bg-[#131025] text-white border border-gray-600 focus:outline-none focus:border-purple-500">
              <h2 className="text-white">
                <MdEventAvailable className="inline mr-2 mb-1 text-purple-500 text-2xl" />
                Availability:
              </h2>
